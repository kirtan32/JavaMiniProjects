...
class MakePanel extends JFrame implements ActionListener,MouseListener
{
	...
	MakePanel(String s)
	{
		...
		ImageIcon img = new ImageIcon("img/cal.png");
		this.setIconImage(img.getImage());
		
		setUndecorated(true);
		cancel = new JButton();
		cancel.setLayout(null);
		cancel.setBounds(5,5,32,32);
		cancel.setContentAreaFilled(false);
		cancel.setBorder(null);
		cancel.setFocusable(false);
		cancel.setIcon(new ImageIcon("img/button1.png"));
		...
		cancel.addMouseListener(new MouseListener() {
			...
			public void mousePressed(MouseEvent arg0) {
				cancel.setIcon(new ImageIcon("img/button2.png"));
			}
		...
		minimize.setBounds(40,5,32,32);
		minimize.setContentAreaFilled(false);
		minimize.setBorder(null);
		minimize.setFocusable(false);
		minimize.setIcon(new ImageIcon("img/button3.png"));
		...
		minimize.addMouseListener(new MouseListener() {
			...
			@Override
			public void mousePressed(MouseEvent arg0) {
				minimize.setIcon(new ImageIcon("img/button4.png"));
		...
		panel_main.add(cancel);
		panel_main.add(minimize);
